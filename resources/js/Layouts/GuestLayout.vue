...
<template>
    <div>
        ...
        <!-- Page Content -->
        <div class="min-h-screene bg-gray-100">
            <nav class="bg-[#424b57]">
                <div class="flex md:hidden justify-between items-center p-1">
                    ...
                    <div>
                        <i @click="showNavDropdown = !showNavDropdown"
                ...
                <div class="hidden md:flex px-2 space-x-4 justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Not implemented -->
                        <!-- <div>
                            <NavLink class="flex items-center" :active="route().current() === 'home.about'"
                                :href="route('home.about')">
                                <span>About</span>
                            </NavLink>
                        </div>
                        <div>
                            <NavLink class="flex items-center" :active="route().current() === 'home.terms'"
                        ...
                        <div v-if="!authenticated" class="space-x-4">
                            ...
                            <NavLink :href="route('register')" :active="route().current() === 'register'">Register
                            </NavLink>
                        </div>
                        <div v-else class="flex items-center space-x-4">
                            ...
                            <div v-if="authName?.length < 10">
                                <NavLink :href="route('dashboard')" :active="route().current() === 'register'">{{
                                    authName }}</NavLink>
                            </div>
                            <div v-else>
                                <NavLink :href="route('dashboard')" :active="route().current() === 'register'"><span
                                        v-html="truncate(authName)"></span></NavLink>
                            </div>
                        </div>
                    </div>
                </div>

                <div v-if="showNavDropdown" class="flex flex-col md:hidden py-2 bg-gray-500 transition-all">
                    <div>
                        ...
                        <div v-else>
                            ...
                            <div v-else>
                                <NavLink :href="route('dashboard')" :active="route().current() === 'dashboard'"><span
                                        v-html="truncate(authName)"></span></NavLink>
                            </div>
                        </div>
                        <!-- Not implemented -->
